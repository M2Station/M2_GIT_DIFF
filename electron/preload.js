...
contextBridge.exposeInMainWorld('api', {
  ...
  moveWorktree: (opts) => ipcRenderer.invoke('repo:moveWorktree', opts),
  ...
  activateProcess: (opts) => ipcRenderer.invoke('system:activateProcess', opts),
  endProcess: (opts) => ipcRenderer.invoke('system:endProcess', opts),
